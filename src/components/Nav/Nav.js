...
import { getPuzzles, slide, submit} from './../../ducks/reducer';
                ...
                <div className="navbar">
                    {
                        ...
                        <div>
                            ...
                            <div className='pf_select'>
                                <select value={this.state.pieces} onChange={this.handlePieces}>
                                ...
                                <select value={this.state.brand} onChange={this.handleBrand}>
                                    ...
                                    <option value='dowdle folk art'>DOWDLE FOLK ART</option>
                                    <option value='lafayette'>LAFAYETTE</option>
                                    <option value='masterpieces'>MASTERPIECES</option>
                                    <option value='new york puzzle co.'>NEW YORK PUZZLE CO.</option>
                                    <option value='pomegranate'>POMEGRANATE</option>
                                    <option value='ravensburger'>RAVENSBURGER</option>
                                    <option value='sunsout'>SUNSOUT</option>
                                    <option value='white mountain'>WHITE MOUNTAIN</option>
                                </select>
                                <select value={this.state.artist} onChange={this.handleArtist}>
                                    <option className='default' value='' selected>SELECT ARTIST</option>
                                    <option value='art poulin'>ART POULIN</option>
                                    <option value='bob pettes'>BOB PETTES</option>
                                    <option value='charles wysocki'>CHARLES WYSOCKI</option>
                                    <option value='eric dowdle'>ERIC DOWDLE</option>
                                    <option value='nicky boehme'>NICKY BOEHME</option>
                                    <option value='hometown'>HOMETOWN</option>
                                    <option value='jane wooster scott'>JANE WOOSTER SCOTT</option>
                            ...
                            <div className='pf_btns'>
                                <button className='submit_btn' onClick={() => this.props.submit(this.state)}>SEARCH</button>
                                <button className='reset_btn' onClick={this.reset}>RESET</button>
                            </div>
                        </div>
                    </div>
...
export default connect(mapStateToProps, { getPuzzles, slide, submit })(Nav);